jQuery(document).ready(function(e) {
    jQuery('#categories > li').clone().appendTo('#mobile_categories');
	jQuery('#info_links > li').clone().appendTo('#mobile_info_links');
	...
	jQuery('#mob-search-trigger').click(function() {
		jQuery('#mob-search').fadeIn(300);
	});
	jQuery('#close_search_btn').click(function() {
		jQuery('#mob-search').fadeOut(300);
	});
});
...
jQuery(document).ready(function(e) {
	...
	jQuery('.homepage-banners').appendTo('#full-width-slider-inner');
});
...
jQuery('#welcome-msg').clone().appendTo('#mob-welcome-msg');
